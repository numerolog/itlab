...
Технологии с помощью которых была производится разработка:
- UML - Унифицированный язык моделирования. С помощью него была спроектирована диаграмма классов системы интернет-конкурса, в который входят подсистемы регистрации участников, подсистемы авторизации по номеру мобильного телефона, подсистемы голосования и вывода итоговых результатов голосования.
...
- https-tls - Для соответствия дожных стандартов безопасности, доступ к системе производится только через защищенные каналы связи по протоколу tls.
